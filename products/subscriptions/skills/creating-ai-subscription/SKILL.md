...
3. **AI subscriptions enabled** for the organization — a PostHog-managed rollout
...
`subscription:write`: an AI subscription runs LLM-generated HogQL over the project's
...
- **Re-enabling a previously auto-disabled AI sub** has two preconditions, both
