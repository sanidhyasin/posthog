...
from products.error_tracking.backend.temporal.activities import cleanup_symbol_sets_activity
from products.error_tracking.backend.temporal.types import SymbolSetCleanupInputs, SymbolSetCleanupResult
from products.error_tracking.backend.temporal.workflow import ErrorTrackingSymbolSetCleanupWorkflow
...
class TestSymbolSetCleanupActivity(BaseTest):
    ...
    def test_deletes_old_used_and_unused_symbol_sets_with_model_semantics(self) -> None:
        ...
        with (
            ...
            patch("products.error_tracking.backend.temporal.activities.close_old_connections"),
        ):
    ...
    def test_delete_unused_false_only_deletes_old_used_symbol_sets(self) -> None:
        ...
        with patch("products.error_tracking.backend.temporal.activities.close_old_connections"):
